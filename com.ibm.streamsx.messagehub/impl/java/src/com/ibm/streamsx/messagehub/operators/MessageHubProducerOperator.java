...
public class MessageHubProducerOperator extends AbstractKafkaProducerOperator {
    ...
    public static final String DESC = ""
    		+ "The **MessageHubProducer** operator is used to consume records from the Bluemix MessageHub service. "
    		...
    		"# Setup\\n" + 
    		"\\n" + 
    		"This section outlines different options for enabling the **MessageHubProducer** operator to connet to Bluemix MessageHub. "
