...
public class MessageHubDeprecatedFileParamTest extends AbstractMessageHubTest {

    private static final String TEST_NAME = "MessageHubDeprecatedFileParamTest";
    private static final String MESSAGEHUB_CREDS_FILE_PATH = "etc/deprecatedParam.json";

    public MessageHubDeprecatedFileParamTest() throws Exception {
        super(TEST_NAME);
    }
    ...
    @Test
    public void messageHubDeprecatedFileParamTest() throws Exception {
